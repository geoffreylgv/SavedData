...
jQuery(function($){
	...
	// For fixed top bar
       $(window).scroll(function(){
        if($(window).scrollTop() >100 /*or $(window).height()*/){
            ...
            $(".navbar-logo img").addClass('logo_highlight');  
        }
    else{    	
      $(".navbar-fixed-top").removeClass('past-main');
      $(".navbar-logo img").removeClass('logo_highlight');
      }
    });
	...
	/* ----------------------------------------------------------- */
		...
		$('.hovering_team .slick-prev').css('display', 'none');
		$('.hovering_team .slick-next').css('display', 'none');
		setTimeout(function() {
			$('.hovering_team').css('right', '-17%');
		},1500);
		...
		var _slideHoveringTeam = function ()
		{
			setInterval(function(){
				$('.slick-prev').click();
				setTimeout(function() {
					$('.hovering_team').removeClass('hovering_team_blur');
	            },500);
				$('.hovering_team').addClass('hovering_team_blur');
			}, 3000);
		}
